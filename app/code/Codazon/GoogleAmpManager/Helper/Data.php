...
class Data extends \Codazon\Core\Helper\Data
{
    ...
    public function renderAmpPageContent()
    {
        ...
        if ($product = $this->getCurrentProduct()) {
            ...
            $this->pageConfig->setMetadata('og:description', strip_tags((string) $product->getMetaDescription()));
    ...
    public function getProuductViewConfigJson($product)
    {
        ...
        $config['description'] = strip_tags((string) $product->getShortDescription());
