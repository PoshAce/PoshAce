...
/**
 * Class Registrationotpsend
 * Magecomp\Mobilelogin\Controller\Index
 */
class Registrationotpsend extends Action implements HttpPostActionInterface
{
    /**
     * @var JsonFactory
     */
    ...
    /**
     * Registrationotpsend constructor.
    ...
    public function execute()
    {
        ...
        if (!$this->getRequest()->isPost()) {
            ...
            $jsonOutput = $this->_helperData->sendRegistrationOTP($data, $websiteId);
        }
