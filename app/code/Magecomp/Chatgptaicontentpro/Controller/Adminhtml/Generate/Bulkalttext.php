...
class Bulkalttext extends Action
{
    ...
    public function execute()
    {
        ...
        foreach ($selectedProducts as $product) {
             ...
             $type = $this->completionConfig->getByType('media_gallery');
             $prompt=$productNames;
             ...
             $existingMediaGalleryEntries = $product->getMediaGalleryEntries();
                if (count($existingMediaGalleryEntries) > 0) {
                    ...
                    $product1->setMediaGalleryEntries($existingMediaGalleryEntries)->setStoreId(0)->save();
                    $this->productRepository->save($product1);
                }
        } 
         $this->messageManager->addSuccessMessage(__('Image Alt Text Updated Successfully for '.$process.' Products'));
