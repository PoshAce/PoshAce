...
{
    protected $_template = 'Magecomp_Chatgptaicontentpro::category/button.phtml';
    ...
    public function getButtonHtml()
    {
        ...
        $button = $this->getLayout()->createBlock('Magento\Backend\Block\Widget\Button')->setData(['id' => 'btn_id', 'label' => __('Generate AI Content'),'class'=>'action-default primary chatgptmetatitle']);
