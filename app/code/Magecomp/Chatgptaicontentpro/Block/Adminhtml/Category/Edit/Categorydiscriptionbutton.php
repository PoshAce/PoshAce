...
class Categorydiscriptionbutton extends \Magento\Backend\Block\Template
{
    protected $_template = 'Magecomp_Chatgptaicontentpro::category/buttondisc.phtml';
    ...
    public function getButtonHtml()
    {
        ...
        $button = $this->getLayout()->createBlock('Magento\Backend\Block\Widget\Button')->setData(['id' => 'btn_id', 'label' => __('Generate AI Content'),'class'=>'action-default primary chatgptmetadisc']);
