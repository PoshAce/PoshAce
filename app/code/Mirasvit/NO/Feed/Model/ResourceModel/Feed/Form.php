...
use Mirasvit\Feed\Model\ResourceModel\Feed;
use Psr\Log\LoggerInterface as Logger;

class Form extends SearchResult
{
    ...
    protected function _initSelect()
    {
        ...
        //            ['report' => $this->getTable('mage_mst_feed_report')],
        //            'report.feed_id = main_table.feed_id and report.created_at = main_table.created_at',
        //            [
