...
class Mteditor extends \Magento\Backend\Block\Template
{
    ...
    public function getImageList()
    {
        ...
        $baseUrl = $this->getStore()
            ->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA).self::MEDIA_IMAGE_DIR.'/';
    ...
    public function getTemplateBlockList()
    {
        ...
        $additionalBlocks = $this->getAdditionalBlockConfig($design, $currentTemplate->getOrigTemplateCode());
        return array_merge($blockArray, $additionalBlocks);
    }
    ...
    public function getTemplateContentHtml()
    {
        ...
        $template->emulateDesign($template->getStoreId(), $template->getDesignConfig()->getArea());
    ...
    public function getAdditionalBlockConfig($design, $templateCode)
    {
        return [];
    }
}
