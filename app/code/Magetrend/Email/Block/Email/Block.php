...
class Block extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     * @var \Magetrend\Email\Helper\Vars
     */
    public $varsHelper;
     ...
     * @param \Magetrend\Email\Helper\Vars $varsHelper
     * @param array $data
     */
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->getVarsHelper()->resolveVariables($this);
    ...
    /**
     * @return \Magetrend\Email\Helper\Vars
     */
    public function getVarsHelper()
    {
