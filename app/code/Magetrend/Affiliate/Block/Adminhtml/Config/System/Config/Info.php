...
namespace Magetrend\Affiliate\Block\Adminhtml\Config\System\Config;
...
{
    const MODULE_NAMESPACE = 'Magetrend_Affiliate';

    const CONFIG_NAMESPACE = 'affiliate';

    const XML_PATH_GENERAL = 'affiliate/general/is_active';
