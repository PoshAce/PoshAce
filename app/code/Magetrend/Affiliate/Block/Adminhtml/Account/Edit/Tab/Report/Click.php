 ...
 */
class Click extends \Magento\Backend\Block\Text\ListText implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    /**
     * Core registry
     *
    ...
    public function _beforeToHtml()
    {
        $this->setChild(
            'generate_code_grid',
            $this->getLayout()->createBlock('Magetrend\Affiliate\Block\Adminhtml\Report\Click\Grid')
        );
