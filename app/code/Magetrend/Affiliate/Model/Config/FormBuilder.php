...
class FormBuilder implements \Magento\Framework\Option\ArrayInterface
{

    public $collectionFactory;

    public function __construct(
        \Magetrend\Affiliate\Model\ResourceModel\FormBuilder\Form\CollectionFactory $collectionFactory
    ) {
